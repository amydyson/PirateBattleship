...
showAllShips()  // see where ships are
...
$(document).ready(function(){
  ...
  $("#start").click(function(){
    ...
    console.log("AI Coordinate is: " + coordinate)

    var currentTd = coordinate //grab id of td clicked
...
///Pause AI pirate
      ...
      if (board[currentTd] === ship1 || board[currentTd] === ship2h || board[currentTd] === ship2v || board[currentTd] === ship3h || board[currentTd] === ship3v || board[currentTd] === ship4h || board[currentTd] === ship4v || board[currentTd] === ship5 ){
         // beginning of if hit!
        //turns square with cannonball if hit

        $("#"+ (coordinate1)+ (coordinate2)).removeClass("ship1show")
        $("#"+ (coordinate1)+ (coordinate2)).removeClass("ship2show")
        console.log("Removing ship1show and ship2show class")
        $("#"+ (coordinate1)+ (coordinate2)).removeClass("ship2show")
        $("#"+ (coordinate1)+ (coordinate2)).removeClass("ship3show")
        $("#"+ (coordinate1)+ (coordinate2)).removeClass("ship4show")
        $("#"+ (coordinate1)+ (coordinate2)).removeClass("ship5show")
        $("#"+ (coordinate1) + (coordinate2)).addClass("hit")
...
/////////////////////////////////////////////////////////////////////////////
     ...
     $("#"+ (coordinate1) + (coordinate2)).addClass("torpedoed")
     console.log("Now adding class of torpedoed")
